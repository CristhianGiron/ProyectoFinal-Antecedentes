...
public class UtilAgreGesAnt {
    /**
     * El siguiente método permite cargar el combo box llamando una ArrayList mediante un dato perteneciente a la clase de un modelo que se desee buscar
     * @param cbx
     * @param lista
     * @param atributoClase 
     */
    ...
    /**
     * El siguiente método permite darle valor a un dato llamando una lista ArrayList un dato perteneciente a la clase de un modelo que se desee buscar
     * @param dato
     * @param lista
     * @param atributoClase 
     */

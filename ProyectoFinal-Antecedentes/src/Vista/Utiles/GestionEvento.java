...
public class GestionEvento extends DefaultTableCellRenderer{
	...
	//etiqueta que almacenara el icono a mostrar
	private JLabel label = new JLabel();
        
	//iconos disponibles para ser mostrados en la etiqueta dependiendo de la columna que lo contenga
	private ImageIcon iconoGuardar = new ImageIcon(getClass().getResource("/Vista/Iconos/IconoEditar1.png"));
	private ImageIcon iconoBuscar = new ImageIcon(getClass().getResource("/Vista/Iconos/IconoBasura.png"));
	...
	/**
	 * Constructor explicito con el tipo de dato que tendra la celda
	 * @param tipo
	 */
	public GestionEvento(String tipo){
		this.tipo=tipo;
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean selected, boolean focused, int row, int column) {
        ...
        /*
         * Si la celda del evento es la seleccionada se asigna el fondo por defecto para la seleccion
         */
        if (selected) {                
        ...
        /*
         * Se definen los tipos de datos que contendran las celdas basado en la instancia que
         * se hace en la ventana de la tabla al momento de construirla
         */
        if( tipo.equals("texto"))
        {
        	//si es tipo texto define el color de fondo del texto y de la celda asi como la alineacion
            if (focused) {
